...
This principle is used to illustrate the scanning feature represented in figure~\ref{fig:ArraySteering}.
...
The antenna array is constructed in such a way that it acts as an equally spaced linear array

The introduction of more antenna elements results in a decreasing main lobe width, this is wanted as it reduces the angle ambiguity when detecting objects. ***



Grating lobes appear when the beam is steered too far away from the zenith and the main beam disappears and reappears on the wrong side.
